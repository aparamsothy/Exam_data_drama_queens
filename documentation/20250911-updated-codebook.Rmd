...
In this document we have included updates to variable names, transformations, and deletions in the datasets [20250905-tidy-exam-data.txt](data/data-for-analysis/20250905-tidy-exam-data.txt). Each variable entry includes its definition, and changes from the previous version.
---
***
___
...
Changed_data <- tribble(
  ...
  "mcv", "Mean Corpuscular (RBC) Volume", "Pivotted from mean_RBC_characteristic",
  "mch", "Mean Corpuscular (RBC) Hemoglobin", "Pivotted from mean_RBC_characteristic",
  "mchc", "Mean Corpuscular (RBC) Hemoglobin per Cell", "Pivotted from mean_RBC_characteristic",
