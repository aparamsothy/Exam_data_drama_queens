...
Changed_data <- tribble(
  ...
  "blood_urea_nitrogen_over_30", "Blood urea nitrogen above 30", "Create a column indicating if the blood urea nitrogen is above 30",
...
deleted_data <- tribble(
  ...
  "mean_RBC_characteristic", "One of: mcv = Mean Corpuscular (RBC) Volume; mch = Mean Corpuscular (RBC) Hemoglobin; mchc = Mean Corpuscular (RBC) Hemoglobin per Cell", "Removed after pivoting", 
  "mean_value", "Value for each of mean_RBD_characteristic", "Removed after pivoting"
)
