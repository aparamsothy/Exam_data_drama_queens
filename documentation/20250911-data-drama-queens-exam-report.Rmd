...
This script form [20250905-Reading-data.R](script/20250905-Reading-data.R) shows the process of reading raw patient data, exploring its structure, cleaning duplicates, and tidying data by removing or adding columns and saving the cleaned dataset.
...
Following are the codes from the script [20250908-tidy-adjust-explore.data.R](script/20250908-tidy-adjust-explore.data.R). In this script we have further tidied the data by removing unnecessary columns, joined with additional dataset, created new set of variables and ordered/arranged the variables.
...
The analysis was conducted in the script [20250909-creating-plots.R](script/20250909-creating-plots.R)
...
Here are the codes from the script [20250910-statistical-analysis.R] (script/20250910-statistical-analysis.R).
